...
class NetellerInfo extends StatefulWidget {
  @override
  _NetellerInfoState createState() => _NetellerInfoState();
}

class _NetellerInfoState extends State<NetellerInfo> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                drawSingleText(
                  title: "Please Insert Your Neteller ID",
                  fontSize: 20,
